    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='volume', to='dishes.ingredient', verbose_name='id ингридиента')),
                ('recipe', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='volume', to='dishes.recipe', verbose_name='id рецепта')),
            ],
        ),
        migrations.AddField(
            model_name='recipe',
            name='ingredients',
            field=models.ManyToManyField(db_index=True, related_name='recipe', through='dishes.Volume', to='dishes.Ingredient', verbose_name='Ингредиенты'),
        ),
        migrations.AddField(
            model_name='recipe',
            name='is_favorite',
